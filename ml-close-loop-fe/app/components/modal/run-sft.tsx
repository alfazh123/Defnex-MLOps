				...
				<DialogContent
					...
					<FieldGroup>
						...
						<Field className="w-full">
							...
							<Select
								items={baseModels.map((f) => ({
									label: f.label,
									value: f.value,
								}))}
								defaultValue={baseModels[0].value}>
						...
						<div className="grid grid-cols-2 gap-4">
							<Field className="w-full">
								...
								<Select
									items={datasets.map((f) => ({
										label: f.title,
										value: f.fileName,
									}))}
									defaultValue={datasets[0].fileName}>
									<SelectTrigger className="w-full">
										<SelectValue />
									</SelectTrigger>
									<SelectContent>
