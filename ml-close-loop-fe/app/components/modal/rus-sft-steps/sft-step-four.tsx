				...
				<FieldGroup>
					<div className="flex flex-col gap-4">
						...
						<div className="flex flex-col gap-3 border p-4 rounded-lg bg-white">
							...
							<div className="grid grid-cols-3 gap-3">
								<Field>
									...
									<Input
										value={value.trainingParams.epochs}
										onChange={(e) =>
											onChange({
												trainingParams: {
								...
								<Field>
									...
									<Input
										value={value.trainingParams.batchSize}
										onChange={(e) =>
											onChange({
												trainingParams: {
													...value.trainingParams,
							...
							<div className="grid grid-cols-3 gap-3">
								...
								<Field>
									...
									<Input
										value={value.trainingParams.warmupRatio}
										onChange={(e) =>
											onChange({
												trainingParams: {
													...value.trainingParams,
								...
								<Field>
									...
									<Input
										value={value.trainingParams.weightDecay}
										onChange={(e) =>
											onChange({
												trainingParams: {
													...value.trainingParams,
							...
							<div className="grid grid-cols-3 gap-3">
								...
								<Field>
									...
									<Select
										value={value.trainingParams.optimizer}
								...
								<Field>
									...
									<Select
										value={value.trainingParams.scheduler}
										onValueChange={(newVal) =>
											onChange({
												trainingParams: {
													...value.trainingParams,
						...
						<FieldDescription className="text-xs text-muted-foreground px-1">
							This is the intended execution configuration for the
							execution configuration — not a live training
							invocation.
						</FieldDescription>
					</div>
				</FieldGroup>
